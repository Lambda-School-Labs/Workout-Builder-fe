...
const InstructionsInput = (props) => {
    ...
    const updateWorkoutDetails = (e) => {
        ...
        updatedProgram.workouts[indexWorkout].description = e.target.value;
    ...
    return ( 
        <input className="instructions-text" value={props.day.description} onChange={updateWorkoutDetails}></input>
    )
}
